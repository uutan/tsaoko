 ...
 *
 * @version $Id: core.php 22996 2014-03-02 14:33:28Z lonestone $
 */
return array (
  ...
  'A role is group of permissions to perform a variety of tasks and operations, for example the authenticated user.' => '角色是代表执行一组人物和操作的授权，例如“已认证用户"。',
  'A task is a permission to perform multiple operations, for example accessing a group of controller action.' => '任务是代表执行多种操作所需的授权，例如访问控制器的一组动作。',
  'Add' => '添加',
  'Add Child' => '添加子项',
  ...
  'Authorization item' => '',
  'Authorization items can be managed under {roleLink}, {taskLink} and {operationLink}.' => '授权项可以在 {roleLink}, {taskLink} 和 {operationLink} 进行管理。',
  'Authorization items created.' => '授权项已创建。',
  'Business rule' => '业务规则',
  ...
  'Generate' => '生成',
  'Generate items' => '生成授权项',
  'Generate items for controller actions' => '为控制器的动作生成授权项',
  'Here you can view and manage the permissions assigned to each role.' => '这里你可以查看和管理分配给每个角色的授权。',
  ...
  'Operation' => '操作',
  'Operations' => '操作',
  'Operations exist below tasks in the authorization hierarchy and can therefore only inherit from other operations.' => '操作是在任务下的授权项，它只能继承其他操作的授权。',
  'Parents' => '父项',
  ...
  'Role' => '角色',
  'Roles' => '角色',
  'Roles exist at the top of the authorization hierarchy and can therefore inherit from other roles, tasks and/or operations.' => '角色是在授权继承的顶层的，所以它可以继承其他角色、任务和操作的授权。',
  'Save' => '保存',
  'Select all' => '全选',
  'Select none' => '不选',
  'Source' => '来源',
  ...
  'Task' => '任务',
  'Tasks' => '任务',
  'Tasks exist below roles in the authorization hierarchy and can therefore only inherit from other tasks and/or operations.' => '任务是在角色下方的授权，所以它可以继承其他任务和操作的授权。',
  ...
  'You are not authorized to perform this action.' => '您没有被授权执行该操作。如需更多权限，请联系超级管理员。',
  'An operation is a permission to perform a single operation, for example accessing a certain controller action.' => '操作是执行一个单项操作的授权，例如访问一个特定的控制器的动作。',
);
